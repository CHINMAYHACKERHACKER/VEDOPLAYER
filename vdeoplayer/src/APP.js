  ...
  return <>
    <BrowserRouter>
      ...
      <Route path="/" element={<HOMEVIDEO/>} />
        ...
        <Route path="/COMMENT/VIDEONOISEREDUCE/:VIDEOONE/VIDEONOISEREDUCE/:VIDEOTWO/VIDEONOISEREDUCE/:VIDEOTHREE/VIDEONOISEREDUCE/:VIDEOFIVE/:USERAUDIO/:ID" element={<COMMENT />}/>
        <Route path="/COMMENT/VIDEO/:VIDEOONE/VIDEO/:VIDEOTWO/VIDEO/:VIDEOTHREE/VIDEO/:VIDEOFIVE/:null/:ID" element={<COMMENT />}/>
        ...
        <Route path="/HOMEVIDEOVIDEO/VIDEONOISEREDUCE/:VIDEOONE/VIDEONOISEREDUCE/:VIDEOTWO/VIDEONOISEREDUCE/:VIDEOTHREE/VIDEONOISEREDUCE/:VIDEOFIVE/:USERAUDIO/:ID" element={<HOMEVIDEOVIDEO />}/>
        <Route path="/HOMEVIDEOVIDEO/VIDEO/:VIDEOONE/VIDEO/:VIDEOTWO/VIDEO/:VIDEOTHREE/VIDEO/:VIDEOFIVE/:null/:ID" element={<HOMEVIDEOVIDEO />}/>
